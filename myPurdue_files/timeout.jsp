...
function alertQueryCallback()
{
    ...
    if (alertXmlHttpRequest.readyState == 4)
    {
        ...
        {
            if (alertXmlHttpRequest.responseText.indexOf("statusCode") == -1)
            {
                window.top.location.href = "https://wl.mypurdue.purdue.edu/jsp/misc/timedout.jsp";
            }
            ...
            {
                window.top.location.href = "https://wl.mypurdue.purdue.edu/cp/home/logout";
            }
            ...
            else if ( alertCode == 50 )            // alert message
            {
                ...
                if ( typeof showAlertAdminMessage != 'undefined' )
                {
...
function doXmlPoll()
{
    if ( typeof checkMuaWindow == "function" ) checkMuaWindow();
...
function checkForWindowClosing()
{
         ...
         window.event.clientY < 0 )   //   the browser window
    {
        ...
        httpGet( logoutXmlHttpRequest, /*URL*/ "/cp/home/logout?src=timeout.jsp" );
    }
}
